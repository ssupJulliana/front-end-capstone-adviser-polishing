// src/components/caps teams board/caps-view-tb.jsx
...
import Attachment from "./caps-attachment";


export default function CapsViewTB() {
  ...
  return (
    <div className="page-wrapper">
      ...
      <h2 className="section-title">
        ...
        Teams Board &gt; To Review &gt; Julliana Castaneda
      </h2>
