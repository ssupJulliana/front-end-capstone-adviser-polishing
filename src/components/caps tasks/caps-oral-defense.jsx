// src/components/caps tasks/caps-tasks.jsx/caps-oral-defense.jsx
import React, { useState, useEffect, useRef } from "react";
import CapsCreateOral from "./caps-create-oral";
              ...
              <tr>
                ...
                <td className="center-text revision-cell" ref={revisionRef}>
                  ...
                  >
                    <div className="revision-badge">
                      {revision}
                      <img src={redDropdownIcon} alt="▼" className="revision-dropdown-icon" />
                    </div>
                ...
                <td className="center-text status-cell" ref={statusRef}>
                  <div className="dropdown-wrapper">
                    ...
                    >
                      {status}
                      <img src={dropdownIconWhite} alt="▼" className="status-dropdown-icon" />
                    </div>
                    {showStatusDropdown && (
                      <div className="dropdown-menu">
...
export default CapsOralDefense;
